...
key = ''
fernet = Fernet(key)
encryptedPassword = b'gAAAAABjT1itzEEg22vK' \
       b'-R85lhXTEcpPjNy6ll6A8NcWg4bejcqqo6dBdrDcBJsOo1wRorQp82Fry8O-l6Raa-' \
                    b'3518VX6kMcy7gUV-DTP5v-EwBatMGU4tQ='

EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'deliverytrackerteam@gmail.com'
EMAIL_HOST_PASSWORD = fernet.decrypt(encryptedPassword).decode()
